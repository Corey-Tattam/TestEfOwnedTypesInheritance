...
{
    public class EntityFrameworkCoreFivePointZeroDemo : BaseEntityFrameworkDemo
    {
        ...
        {
            await ExecuteDemoMethodWithScopedContextAsync((db) => EfCoreFivePointZeroDemo_SimpleLoggingAsync(db));
            await ExecuteDemoMethodWithScopedContextAsync((db) => EfCoreFivePointZeroDemo_FilteredIncludeAsync(db));
        }
